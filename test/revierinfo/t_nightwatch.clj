...
(facts "about 'nightwatch'"
       ...
       (fact "a nigtwatch record cannot be created for dates before April 15 or after October 15"
             ...
             (nw/create (t/date-time 2020 10 16)) => (throws Exception "Date must be betwen April 15 and October 15, inclusive")
             (nw/create (t/date-time 2009 12 01)) => (throws Exception "Date must be betwen April 15 and October 15, inclusive")
             )
       )
)
